  ...
  <section class="bg-surface-container-low py-section-gap px-margin-mobile md:px-margin-desktop">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="flex justify-between items-end mb-12 md:mb-16">
        <div>
          <span class="font-label-caps text-label-caps text-secondary uppercase tracking-widest">Descuentos</span>
          <h2 class="font-headline-lg text-headline-lg-mobile md:text-headline-lg uppercase mt-2">Outlet Sale-OFF</h2>
        </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-gutter">
        <ProductCard 
          v-for="product in products.getOutletProducts()"
          :key="product.id"
          :product="product"
